...
export class HealerEnemy extends Enemy {
    ...
    private createMeshFromGLB(asset: GlbContainer): void {
        this.usingGLB = true;
        this.mesh = createTransformHost('healerEnemyGlbRoot', this.scene);
    ...
    protected createDeathEffect(): void {
        ...
        // Green/purple mystic poof, floating upward (gravity is negative = anti-gravity).
        const particleSystem = new ParticleEffect(
            ...
            this.scene,
            {
                ...
                startColor: { min: { r: 0.30, g: 0.95, b: 0.50 }, max: { r: 0.40, g: 0.25, b: 0.65 } },
                startOpacity: 1,
